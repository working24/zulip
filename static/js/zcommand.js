...
export function process(message_content) {
    ...
    if (content.match(/^\/accounting_closing_term/g)) {
        ...
        send_webhook(hook_temp_url, content);
        return true;
    } else if (content.match(/^\/billing_paid/g)) {
        hook_temp_url = "https://io.working24.net/webhook/be8a5c3c-076a-457c-a54a-81eb821ea9de";
        send_webhook(hook_temp_url, content);
        return true;
        ...
        send_webhook(hook_temp_url, content);
        return true;
    } else if (content.match(/^\/task_check/g)) {
        hook_temp_url = "https://io.working24.net/webhook/ec0a2d99-819b-45dd-b3d3-08345e438902";
        send_webhook(hook_temp_url, content);
        return true;
        ...
        send_webhook(hook_temp_url, content);
        return true;
    } else if (content.match(/^\/task_post/g)) {
        hook_temp_url = "https://io.working24.net/webhook/dabe0a29-9829-4bb8-9f85-53e8b6955df2";
        send_webhook(hook_temp_url, content);
        return true;
        ...
        send_webhook(hook_temp_url, content);
        return true;
    } else if (content.match(/^\/unapprove/g)) {
        hook_temp_url = "https://io.working24.net/webhook/a6367849-f3f1-441c-87d7-474130c7c0dd";
        send_webhook(hook_temp_url, content);
        return true;
        ...
        send_webhook(hook_temp_url, content);
        return true;
    } else if (content.match(/^\/webpage_change/g)) {
        hook_temp_url = "https://io.working24.net/webhook/95062bd5-0023-4a4a-8ed4-1b1a50746f64";
        send_webhook(hook_temp_url, content);
        return true;
    } else if (content.match(/^\/webpage_domain/g)) {
        hook_temp_url = "https://io.working24.net/webhook/dec64369-d802-4d0e-acec-4c852578a922";
        send_webhook(hook_temp_url, content);
        return true;
